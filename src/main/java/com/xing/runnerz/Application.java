...
import com.xing.runnerz.user.User;
import com.xing.runnerz.user.UserHttpClient;
import com.xing.runnerz.user.UserRestClient;
...
public class Application {
	...
	UserHttpClient userHttpClient() {
		...
		return factory.createClient(UserHttpClient.class); // create an agent class based on the interface, return instance of this class
	}
